...
#notifying the server for the actions performed by the client 
    def notify_server(self, action, action_type):
        ...
        if action_type == "login":
            ...
            self.sock.close()
#notify the server to send encoded messages to the server
